...
public class Queen extends Piece {
  ...
  static {
    Queen.white = (new javax.swing.ImageIcon(Pawn.class.getResource("resources/white-queen.png"))).getImage();
    Queen.black = (new javax.swing.ImageIcon(Pawn.class.getResource("resources/black-queen.png"))).getImage();
  }
  ...
  @Override
  public Piece copy() {
    Piece copy = new Queen(new Point(this.position), this.color);
  ...
  public void paint(Graphics g) {
    if(this.color == Color.WHITE)
      g.drawImage(Queen.white, (this.position.x - 1) * 100, (this.position.y - 1) * 100, null);
    else
      g.drawImage(Queen.black, (this.position.x - 1) * 100, (this.position.y - 1) * 100, null);
  }
}